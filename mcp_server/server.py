...
def _list_tool_specs() -> list[dict[str, object]]:
    return [
        {
            "name": "search",
            "description": "Search mobility and transportation updates.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "query": {"type": "string"},
        ...
        {
            "name": "recent_updates",
            "description": "List recently collected mobility articles from DuckDB.",
            "inputSchema": {
                "type": "object",
                "properties": {
        ...
        {
            "name": "top_trends",
            "description": "Show top entity frequencies from recent mobility article matches.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "days": {"type": "integer", "minimum": 1},
...
def create_app() -> _McpApp:
    ...
    app = server_ctor("mobility-radar")
