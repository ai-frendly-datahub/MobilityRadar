...
Article = cast(_ArticleCtor, import_module("mobilityradar.models").Article)
EntityDefinition = cast(_EntityCtor, import_module("mobilityradar.models").EntityDefinition)
apply_entity_rules = cast(_ApplyEntityRules, import_module("mobilityradar.analyzer").apply_entity_rules)
