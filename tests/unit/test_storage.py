...
StorageError = cast(type[Exception], import_module("mobilityradar.exceptions").StorageError)
...
RadarStorage = cast(_RadarStorageCtor, import_module("mobilityradar.storage").RadarStorage)
